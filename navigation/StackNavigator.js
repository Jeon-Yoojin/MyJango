...
import Ingredients_add from '../ingredients_add/ingredients_add';
...
import SearchDate from '../recipe_list/FindRecipe';
import SearchLike from '../recipe_list/FindRecipe';
...
const StackNavigator = () => {
  return(
      ...
      >
        <Stack.Screen name="MAINNAV" component={DrawerNavigation}
          options={{
            title: '메인화면'
        }}/>
