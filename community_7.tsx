...
const App = () => {
  ...
  const style = StyleSheet.create({
   ...
   expireddate2_1 : {backgroundColor:color1, borderRadius: 10, margin: 10, fontSize: 18, padding:3},
   expireddate2_2 : {backgroundColor:color2, borderRadius: 10, margin: 10, fontSize: 18, padding:3},
   expireddate2_3 : {backgroundColor:color3, borderRadius: 10, margin: 10, fontSize: 18, padding:3},
   expireddate2_4 : {backgroundColor:color4, borderRadius: 10, margin: 10, fontSize: 18, padding:3},
   expireddate2_5 : {backgroundColor:color5, borderRadius: 10, margin: 10, fontSize: 18, padding:3},
   expireddate2_6 : {backgroundColor:color6, borderRadius: 10, margin: 10, fontSize: 18, padding:3},
   expireddate2_7 : {backgroundColor:color7, borderRadius: 10, margin: 10, fontSize: 18, padding:3},
   expireddate2_8 : {backgroundColor:color8, borderRadius: 10, margin: 10, fontSize: 18, padding:3},
...
<View style={style.temp2}>
 ...
 <Text style = {{fontSize: 18, fontWeight: 'bold', margin: 15}}>넉넉</Text>
  ...
  <View style={style.temp02}> 
  <TouchableHighlight style={style.expireddate1}>
  ...
  <Text>    </Text>
  <TouchableHighlight style={style.expireddate01}>
