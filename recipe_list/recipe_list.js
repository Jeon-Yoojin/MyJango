        ...
        <View style={styles.view}>
          ...
          <TouchableOpacity onPress={searchWith}>
            ...
            <View style={styles.buttonview}>
                <TouchableOpacity style={[styles.red, { backgroundColor: SDselect }]} onPress={()=>{modifySD()}}>
                    <Text style={styles.white}>유통기한</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.red, { backgroundColor: SLselect }]} onPress={()=>{modifySL()}}>
                    <Text style={styles.white}>즐겨찾기</Text>
                </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
    ...
    red: { width:71, height:38, borderRadius:5, backgroundColor: '#FF5454', padding:8, marginHorizontal:5 },
    white: {
      fontSize:14, textAlign:"center"
    },
    buttonview: { flexDirection: "row", paddingLeft: 18, margin: 5, width:200 },
    ...
    textInputStyle: { width: 300, height: 50, backgroundColor: "white", margin: 10 }
});
