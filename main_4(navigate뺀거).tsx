...
const style = StyleSheet.create({
 ...
 triangle: {position:"relative", left:90, top:-50},
 ...
 textInputStyle: {position: "relative", left: 35, top:-20, width : 300, height : 50, backgroundColor: "white", margin:2, fontSize: 15},
...
const App = () => {
 ...
 <Icon2 name="search" size={50} color={Colors.red100} style={{position:"relative", top:18}}/> 
 <TextInput style={style.textInputStyle}
  ...
  <View style={style.temp03}> 
    <Text style={style.expireddate1}><Image style={style.Img1} source={FridgeFillPath}/></Text>
    <Text style={style.expireddate2}> <Image style={style.Img2} source={LightbulbFillPath}/></Text>
    <Text style={style.expireddate3}><Image style={style.Img3} source={ChatFillPath}/></Text>
  </View>
  <View style={style.temp03}> 
  ...
  <Text style={style.TitleText2}>유통기한 임박{'>'}</Text>
  </View>
...
<View style={style.temp04}> 
  ...
  <Text style={style.expireddate5}>+</Text>
  </View> 
